...
export default function SearchFilter() {
  ...
  return (
    <section className='my-8 px-4 sm:px-8 md:px-12 md:flex md:justify-between md:items-center'>
            <div className='flex my-2 w-full gap-4 items-center shadow-md rounded-sm bg-white px-4 py-2 md:w-1/3 md:my-0'>
                ...
                <input className='outline-none text-sm' type="text" name="" id="" placeholder='Search for a country..' />
            </div>
            <div className='relative w-1/2 md:w-max'>
                <div className=' flex justify-between gap-6 items-center p-2 bg-white shadow-sm rounded-sm text-sm'>
                ...
                {showFilter ? 
                <div className='absolute my-2 bg-white w-full py-2 shadow-md rounded-sm'>
                    {regions.map((region) => {
